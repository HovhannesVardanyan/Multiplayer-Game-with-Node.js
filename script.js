...
$(function()
{
		...
		queue.loadManifest
		(
			[{id:"grass",src:"/gui/terrain/grass.png"},{id:"red",src:"/gui/camp/red.png"},{id:"blue",src:"/gui/camp/blue.png"},{id:"yellow",src:"/gui/camp/yellow.png"},{id:"green",src:"/gui/camp/green.png"},{id:"blu",src:"/gui/truck/blue.png"},{id:"gre",src:"/gui/truck/green.png"},{id:"re",src:"/gui/truck/red.png"},{id:"yell",src:"/gui/truck/yellow.png"},{id:"stone",src:"/gui/obstacle/default.png"},{id:"res",src:"/gui/resource/gold.png"},{id:"energy",src:"/gui/resource/power.png"},{id:"fog",src:"/gui/fog.png"}]
		);
			...
			if(data["player"] == "first")
				...
				function movement(evt)
				{
					...
					if(player1!==undefined)
					{
						if(evt.keyCode==40)
						{
									socket.emit("move", {"player":player1.who, "y" : player1.y,  "x" : player1.x,"dir" : "down","width":"16","height":"16","c":"800","plx":player1.x+16,"ply":player1.y+16,"radx":player1.x+32,"rady":player1.y+32,"kicking":false,"value":player1.value});
									lastDir="down";
									}
					   else if(evt.keyCode==38)
						{
									socket.emit("move", {"player":player1.who, "y" : player1.y, "x" : player1.x, "dir" : "up","width":"16","height":"16","c":"800","plx":player1.x+16,"ply":player1.y+16,"radx":player1.x+32,"rady":player1.y+32,"kicking":false,"value":player1.value});
									lastDir="up";
									}
						else if(evt.keyCode==37)
						{
									socket.emit("move", {"player":player1.who, "x" : player1.x,"y" : player1.y, "dir" : "left","width":"16","height":"16","c":"800","plx":player1.x+16,"ply":player1.y+16,"radx":player1.x+32,"rady":player1.y+32,"kicking":false,"value":player1.value});
									lastDir="left";
						}			
						else if(evt.keyCode==39)
						{
									socket.emit("move", {"player":player1.who, "x" : player1.x,"y" : player1.y, "dir" : "right","width":"16","height":"16","c":"800","plx":player1.x+16,"ply":player1.y+16,"kicking":false,"value":player1.value});
									 lastDir="right"
						}		
                                               else if(evt.keyCode==75)
											    {
												socket.emit("move", {"player":player1.who, "x" : player1.x, "y" : player1.y, "dir" : lastDir,"width":16,"height":16,"c":"800","kicking":true});
												}                      
					...
					else if(player2!==undefined)
					{
						if(evt.keyCode==40)
						{
									socket.emit("move", {"player":player2.who, "y" : player2.y, "x" : player2.x,"dir" : "down","width":"16","height":"16","c":"800","plx":player2.x+16,"ply":player2.y+16,"radx":player2.x+32,"rady":player2.y+32,"value":player2.value});
									lastDir="down"
									}
					   else  if(evt.keyCode==38)
						{
									socket.emit("move", {"player":player2.who, "y" : player2.y,"x" : player2.x, "dir" : "up","width":"16","height":"16","c":"800","plx":player2.x+16,"ply":player2.y+16,"radx":player2.x+32,"rady":player2.y+32,"value":player2.value});
									lastDir="up";
									}
						else if(evt.keyCode==37)
						{
									socket.emit("move", {"player":player2.who, "x" : player2.x,"y" : player2.y, "dir" : "left","width":"16","height":"16","c":"800","plx":player2.x+16,"ply":player2.y+16,"radx":player2.x+32,"rady":player2.y+32,"value":player2.value});
									lastDir="left";
						}			
						else if(evt.keyCode==39)
						{
									socket.emit("move", {"player":player2.who, "x" : player2.x, "y" : player2.y,"dir" : "right","width":"16","height":"16","c":"800","plx":player2.x+16,"ply":player2.y+16,"radx":player2.x+32,"rady":player2.y+32,"value":player2.value});
									lastDir="right";
						}				
                                        else if(evt.keyCode==75)
											    {
												socket.emit("move", {"player":player2.who, "x" : player2.x, "y" : player2.y, "dir" : lastDir,"width":16,"height":16,"c":"800","kicking":true});
												}  						
									}
					...
					else if(player3!==undefined)
					{
						if(evt.keyCode==40)
						{
							...
							socket.emit("move", {"player":player3.who,"x" : player3.x, "y" : player3.y, "dir" : "down","width":"16","height":"16","c":"800","plx":player3.x+16,"ply":player3.y+16,"radx":player3.x+32,"rady":player3.y+32,"value":player3.value});
							lastDir="down";
							}
									
					   else  if(evt.keyCode==38)
						{
									socket.emit("move", {"player":player3.who,"x" : player3.x, "y" : player3.y, "dir" : "up","width":"16","height":"16","c":"800","plx":player3.x+16,"ply":player3.y+16,"radx":player3.x+32,"rady":player3.y+32,"value":player3.value});
									lastDir="up";
									}
						else if(evt.keyCode==37)
						{
									
									socket.emit("move", {"player":player3.who,"x" : player3.x, "y" : player3.y, "dir" : "left","width":"16","height":"16","c":"800","plx":player3.x+16,"ply":player3.y+16,"radx":player3.x+32,"rady":player3.y+32,"value":player3.value});
						          lastDir="left";
						}			
						else if(evt.keyCode==39)
						{
									socket.emit("move", {"player":player3.who, "x" : player3.x, "y" : player3.y, "dir" : "right","width":"16","height":"16","c":"800","plx":player3.x+16,"ply":player3.y+16,"radx":player3.x+32,"rady":player3.y+32,"value":player3.value});
						lastDir="right";
						}		
                                        else if(evt.keyCode==75)
											    {
												socket.emit("move", {"player":player3.who, "x" : player3.x, "y" : player3.y, "dir" : lastDir,"width":16,"height":16,"c":"800","kicking":true});
												}  							
										...
										else if(player4!==undefined)
					{
						if(evt.keyCode==40)
						{
									socket.emit("move", {"player":player4.who, "x" : player4.x, "y" : player4.y, "dir" : "down","width":"16","height":"16","c":"800","plx":player4.x+16,"ply":player4.y+16,"radx":player4.x+32,"rady":player4.y+32,"value":player4.value});
									lastDir="down";
									}
					   else  if(evt.keyCode==38)
						{
									socket.emit("move", {"player":player4.who, "x" : player4.x, "y" : player4.y, "dir" : "up","width":"16","height":"16","c":"800","plx":player4.x+16,"ply":player4.y+16,"radx":player4.x+32,"rady":player4.y+32,"value":player4.value});
									lastDir="up";
									}
						else if(evt.keyCode==37)
						{
									socket.emit("move", {"player":player4.who, "x" : player4.x, "y" : player4.y ,"dir" : "left","width":"16","height":"16","c":"800","plx":player4.x+16,"ply":player4.y+16,"radx":player4.x+32,"rady":player4.y+32,"value":player4.value});
						lastDir="left";
						}			
						else if(evt.keyCode==39)
						{
									socket.emit("move", {"player":player4.who, "x" : player4.x, "y" : player4.y, "dir" : "right","width":16,"height":16,"c":"800","plx":player4.x+16,"ply":player4.y+16,"radx":player4.x+32,"rady":player4.y+32,"value":player4.value});
						    lastDir="right";
						}		
                          else if(evt.keyCode==75)
											    {
												socket.emit("move", {"player":player4.who, "x" : player4.x, "y" : player4.y, "dir" : lastDir,"width":16,"height":16,"c":"800","kicking":true});
												} 
